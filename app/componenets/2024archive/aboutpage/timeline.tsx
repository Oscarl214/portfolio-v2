                  ...
                  <div className="collapse-content">
                    <a className="font-sans text-md ">
                      <p>
                        ...
                        Communications and Arts & Entertainment Technologies,
                        where I first got introduced to coding.
                      </p>
                    </a>
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="collapse-content">
                    <p className="font-sans text-md">
                      Following graduation, I interned with Oracle, where I
                      joined the Global Alliance Partner Marketing Team for an
                      eight-week internship program. This experience honed my
                      skills in project management, collaboration, and
                      creativity. I contributed to the Deloitte partnership by
                      leveraging my coding knowledge to create promotional
                      materials, design webpages, and enhance digital assets.
                    </p>
                  </div>
                </div>
              </motion.div>
                ...
                >
                  ...
                  <div className="collapse-content">
                    <p className="font-sans text-md">
                      ...
                      Developed one-page applications and full-stack apps using
                      the MERN stack, and gained proficiency in MySQL, Node.js,
                      and GraphQL.
                    </p>
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="collapse-content">
                    <p className="font-sans text-md">
                      ...
                      primarily work with HTML and CSS modules to execute
                      marketing campaigns. My responsibilities include HTML
                      coding, executing day-to-day digital marketing campaigns,
                      partnering with internal team members for QA, approval,
                      and deployment of campaigns, ensuring that all campaigns
                      deploy as planned, serving as a digital marketing platform
                      end-user expert, and providing guidance around digital

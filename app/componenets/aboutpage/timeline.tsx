        ...
        <ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical  lg:mt-10">
          ...
          <li>
            ...
            <motion.div initial={{opacity:0}} whileInView={{opacity:1}} transition={{duration:1.5}}>
              ...
              <p className="font-sans text-md">
                Following graduation, I interned with Oracle, where I joined the
                Global Alliance Partner Marketing Team for an eight-week
                internship program. This experience honed my skills in project
                management, collaboration, and creativity. I contributed to the
          ...
          <li>
            ...
            <motion.div initial={{opacity:0}} whileInView={{opacity:1}} transition={{duration:1.5}}>
              ...
              <p className="font-sans text-md">
                ...
                {''} from completing a six-month, project-intensive, full-stack
                coding bootcamp, where I learned Agile methodologies and
                collaborated on full-stack projects. Developed one-page
          ...
          <li>
            ...
            <motion.div initial={{opacity:0}} whileInView={{opacity:1}} transition={{duration:1.5}}>
              ...
              <p className="font-sans text-md">
                Currently employed as an Assistant Email Developer, I primarily
                work with HTML and CSS modules to execute marketing campaigns.
                My responsibilities include HTML coding, executing day-to-day
                digital marketing campaigns, partnering with internal team
                members for QA, approval, and deployment of campaigns, ensuring
                that all campaigns deploy as planned, serving as a digital

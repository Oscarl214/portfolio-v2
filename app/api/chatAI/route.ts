   ...
   Oscar graduated from the University of Texas at Austin. He has a bachelor of Science in Communications & a Bachelor of Science in Arts & Entertainment Technologies.
    His favorite NFL team are The Dallas Cowboys. His favorite soccer team is Real Madrid.
     His favorite college football team is the Texas LongHorns.
      His favorite baseball team is The Texas Rangers.Oscar favorite food is Chicken Wings. 
      Oscar loves traveling and working out. Oscar has been to China,Canada, Mexico, United Arab Emirates,Switzerland, Germany, Puerto Rico, & Guatemala.
...
`;
  ...
  const response = await openai.chat.completions.create({
    messages: [
      {
        role: 'system',
        content: `You are a helpful assistant who knows all about Oscar and his 
        skills, achievements, and goals. 
        Do not share anything that is not included in the details provided. 
        Here are Oscars Details: ${oscarDetails}`,
      },
      {
        role: 'user',
        content: question,
